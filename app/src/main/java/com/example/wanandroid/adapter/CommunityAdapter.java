...
public class CommunityAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<ProjectCommunityBean> list;
    private LayoutInflater inflater;
    private OnItemClickListener listener;

    public CommunityAdapter(Context context, ArrayList<ProjectCommunityBean> list){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position, @NonNull List payloads) {
        ...
        ProjectCommunityBean data = list.get(position);
        if (payloads.size() == 0) {
    ...
    private void commonBind(ViewHolder h, ProjectCommunityBean data, final int position) {
